...
if __name__ == '__main__':
    ...
    os.system('python3 common/deploy_network.py --seq_name sa --data_dir demo_image '
    ...
    # # Deploy the segmentation network
    # print('Deploying the segmentation network ...')
    # os.system('python3 common/deploy_network.py --seq_name la_2ch --data_dir demo_image '
    #           '--model_path trained_model/FCN_la_2ch'.format(CUDA_VISIBLE_DEVICES))
    #
    # os.system('python3 common/deploy_network.py --seq_name la_4ch --data_dir demo_image '
    ...
    # # Deploy the segmentation network
    # print('Deploying the segmentation network ...')
    # os.system('python3 common/deploy_network_ao.py --seq_name ao --data_dir demo_image '
